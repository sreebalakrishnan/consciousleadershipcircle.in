...
/musings/a-day-with-ram-charan → musings/a-day-with-ram-charan.html  Musing: Vikas Anand — five take-aways from a one-day Ram Charan workshop (three leader traits · the salesperson's gift · right people in right jobs · inside-out vs outside-in future-back goal-setting · personal growth as the lever for excellence). Lightly polished but kept in Vikas's voice; opens with a short editorial note that the points/structure are his. Closes with his actual sign-off ("Hopefully it would be relevant to the leaders") in a `.signoff` block. Reading list: 4 Amazon.in searches for Ram Charan books (Execution, What the CEO Wants You to Know, The Attacker's Advantage, The Leadership Pipeline). Uses the `.practice` block pattern from `what-the-system-sees.html` for each take-away
...
### Musings live
- **A day with Ram Charan** — five take-aways from a one-day company-sponsored workshop with Dr. Ram Charan: the three characteristics of a high-performing leader (clarity, visualisation + accountability, creating interest), the best salesperson's single gift (understanding the customer's needs), keeping the right people in the right jobs (job content, KPIs, training, accountability + follow-through), goal-setting from the future back vs the rear-view, and personal growth as the lever for people to excel. Lightly polished but Vikas's structure and voice throughout; closes with his actual sign-off line. By Vikas Anand. `/musings/a-day-with-ram-charan.html`
